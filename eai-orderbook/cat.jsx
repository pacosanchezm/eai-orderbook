...
const Body = props => {
  ...
  const [Extend, setExtend] = props.useContext.Extend.Cat
        ...
        >
          ...
          <Flex sx={{ width: "100%", height: "27px", borderBottomStyle: "solid", borderWidth:1, borderColor: "#D3D3D3", borderRadius: "0px", mt:2, mb:2 }}>
            <Box sx={{ width: "90%", mb:2 }}>
              <Text sx={Estilo.d1sb}>Productos</Text>
            </Box>
    ...
    return (
      <Grid sx={{p:0, m: 0, borderStyle: "solid", borderWidth:1, borderColor: "#D3D3D3", borderRadius: "5px"}}>
        ...
        {Loading ? <Spinner size={17} ml={3} /> : 
          <div>
            {(props.useStatus.cat()===1 & Extend) ? ModuloSimple() : <div/>}
            {(props.useStatus.cat()===1 & !Extend) ? ModuloSlim() : <div/>}
